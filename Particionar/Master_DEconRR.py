...
# DESPACHO ECONOMICO CON CRITERIOS DE RESERVA
...
# PARTICIONES
#_model.barras_zona1 = Param(mutable=True,
    #                            default=['SING_Norte', 'SING_Centro', 'SING_Sur'])
#_model.barras_zona2 = Param(mutable=True,
#                            default=['SIC_CentroSurA', 'SIC_CentroSurC', 'SIC_Sur', 'SIC_Centro', 'SIC_CentroNorte'])

# PARAMETROS DE CONFIGURACION; 
# Nzonas = Numero de zonas a usar
# c_res = valor de penalizacion de reserva
# barras_zona1 = [barra1, barra2...]
# barras_zona2...
# barras_zonaN
...
# CT 9: Fijar Requerimientos de reserva
def fix_req_res_z1(model):
    return model.REQ_RES_Z1 == model.Req_Z1


def fix_req_res_z2(model):
    return model.REQ_RES_Z2 == model.Req_Z2

_model.CT_fix_req_res_z1 = Constraint(rule=fix_req_res_z1)
_model.CT_fix_req_res_z2 = Constraint(rule=fix_req_res_z2)

# CT 10: Cortes, en caso de ser necesario
